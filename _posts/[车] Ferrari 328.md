...
全新308 GTB代表了第二代法拉利V8发动机公路车，于1975年在巴黎沙龙首次亮相。这个特殊的车型系列始于1973年，带有 Dino 徽章的 308 GT4 2+2 取代了上一代车型。 V6 发动机 Dino 246 GT。这款新车型的楔形造型（由博通设计，而不是传统的宾尼法利纳设计）并未受到普遍欢迎。然而，安装在船中部的双顶置凸轮轴 3.0 升 V8 发动机的性能确实如此，而且 308 GT4 的两座后继车型也使用了相同动力装置的干油底壳版本。令人惊叹的美丽 308 GTB 采用较短的轴距，标志着宾尼法利纳 (Pininfarina) 风格的回归。进一步的发展包括 1977 年推出带有 Targa 式可拆卸车顶的敞篷 GTS 版本、采用博世 K-Jetronic 燃油喷射系统（1980 年），最后改进了每缸四气门的气缸盖（1982 年）。

1985 年，308 被机械结构相似但发动机更大的 328 GTB 所取代。通过增加缸径和冲程，quattrovalvole 发动机的排量提高到 3,186cc，再加上更高的压缩比、改进的活塞和改进的马瑞利发动机管理系统，将最大功率提升到 7,000rpm 时的 270bhp。最高时速提升至 160 英里/小时（258 公里/小时），加速到 60 英里/小时只需 5.5 秒。从外观上看，宾尼法利纳原版 308 的优雅简约风格因添加了 Testarossa 风格的模制保险杠（包含侧灯和指示灯）、更深的后帷幔和不引人注目的车顶扰流板而有所淡化。但其潜在的美丽是无法掩饰的。 《汽车》杂志宣称：“即使原始形状的崇高纯洁性已经被破坏，但其引人注目的外观却没有被破坏。”该杂志继续说道，“在我们的书中，这仍然是所有当代异国情调中最美丽的——一辆外观华丽的汽车。”

在表面之下，管状钢制底盘仍然与以前一样，配有双横臂全方位独立悬架、四轮伺服辅助盘式制动器和铝合金车轮，尽管后者尺寸有所增加。内饰也进行了微妙的修改，现在配备了改进的仪表开关装置和加热装置。 328 GTB/GTS 一直生产到 1989 年，使该车型成为有史以来商业上最成功的法拉利车型。
...
![25]({{ '/assets/images/cars/ferrari_328/25.jpg' | relative_url }}){: style="width: 400px; max-width: 100%;"} | ![26]({{ '/assets/images/cars/ferrari_328/26.jpg' | relative_url }}){: style="width: 400px; max-width: 100%;"} | ![27]({{ '/assets/images/cars/ferrari_328/27.jpg' | relative_url }}){: style="width: 400px; max-width: 100%;"}
